...
const ENTRYSCAPE_URL = process.env.NEXT_PUBLIC_ENTRYSCAPE_URL || "http://34.51.236.117/admin";
const ENTRYSTORE_URL = process.env.NEXT_PUBLIC_ENTRYSTORE_URL || "http://34.51.236.117/store";
